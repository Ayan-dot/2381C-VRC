...
autons::autons(int default_auton, const char **autons) {
	int i = 0;
        do{
...
lv_res_t autons::blueAction(lv_obj_t *btnm, const char *txt)
{
...
lv_res_t autons::redAction(lv_obj_t *btnm, const char *txt){
