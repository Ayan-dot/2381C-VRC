...
void autonomous() {
    ...
    translationPID(20.0, 43.0, pi/5.8, pros::millis(), 800, true, true, false,0,0,10000);
  ...
  //
    translationPID(63.0, 34.0, pi/2.0, pros::millis(), 900, true, false, false,0,0,10000);
    turnPID(0.0, pros::millis(), 600);
  //
  translationPID(63.0, 40.0, lastAngle, pros::millis(), 600, true, true, false,0,0,8600);
  shootingProcedure(false);
  shootingProcedure(false);
  translationPID(63.0, 25.0, pi/4.1, pros::millis(), 800, false, false, true,0,0,10000);
  ...
  translationPID(88.5, 44.0, lastAngle, pros::millis(), 1800, true, true, false,0,0,10000);
  //
  translationPID(118.0, 38.0, pi/4.0, pros::millis(), 900, true, true, false,0,0,10000);
    translationPID(119.0, 44.0, pi/4.0, pros::millis(), 600, false, false, false,0,0,10000);
  shootingProcedure(false);
  translationPID(109.0, 43.0, lastAngle, pros::millis(), 600, false, false, false,0,0,8600);
  ...
  translationPID(112.0, -11.0, pi/2.0, pros::millis(), 1000, true, true, false,0,0,8600);
  translationPID(118.0, -11.0, pi/2.0, pros::millis(), 300, false, false, false,0,0,8600);
  shootingProcedure(false);
  shootingProcedure(false);
  // translationPID(112.0, -10.0, lastAngle, pros::millis(), 600, false, false, false,0,0,8600);
  translationPID(107.0, -11.0, lastAngle, pros::millis(), 500, false, false, false,0,0,8600);
  turnPID(pi, pros::millis(), 600);
  translationPID(109.0, -55.0, pi/2.0+pi/4.0, pros::millis(), 1500, true, true, false,0,0,10000);
  translationPID(120.0, -68.0, pi/2.0+pi/4.0, pros::millis(), 1000, false, false, false,0,0,8600);
  shootingProcedure(false);
  translationPID(109.0, -55.0, pi, pros::millis(), 800, false, false, false,0,0,10000);
  turnPID(pi+pi/2.0, pros::millis(), 600);
  translationPID(64.0, -60.0, lastAngle, pros::millis(), 1500, true, true, false,0,0,8600);
  translationPID(64.0, -57.0, pi+pi/4.0, pros::millis(), 600, false, false, false, 0, 0, 10500);
  turnPID(pi, pros::millis(), 400);
  translationPID(64.0, -64.0, pi, pros::millis(), 600, true, false, false,0,0,8600);
  shootingProcedure(false);
  shootingProcedure(false);
  translationPID(65.0, -55.0, pi, pros::millis(), 600, false, false, false,0,0,8600);
turnPID(pi+pi/4.0, pros::millis(), 600);
  translationPID(32.0, -70.0, pi+pi/4.2, pros::millis(), 1400, true, true, false,0,0,10000);
  translationPID(7.5, -62.0, pi+pi/4.0, pros::millis(), 1100, true, true, false,0,0,10000);
  translationPID(6.5, -69.0, pi+pi/3.9, pros::millis(), 400, false, false, false,0,0,10000);
  shootingProcedure(false);
  translationPID(6.5, -72.0, pi+pi/3.9, pros::millis(),900, true, true, false,0,0,8600);
  translationPID(15.0, -67.0, lastAngle, pros::millis(),900, false, true, false,0,0,8600);
  turnPID(2*pi,pros::millis(), 700);
  // translationPID(14.0, -68.0, lastAngle, pros::millis(),1000, false, false, false,2,0,8600);
  descoreProcedure2();
  translationPID(13.0, -38.0, 2*pi+pi/4.0, pros::millis(),1300, true, true, false,0,0,10500);
  translationPID(41.0, -6.0, 2*pi+pi/4.0, pros::millis(),1300, true, true, false,0,0,10000);
  turnPID(pi+pi/2.0, pros::millis(), 700);
  translationPID(10.0, -12.0, pi+pi/2.0, pros::millis(),1200, true, true, false,0,0,10000);
  shootingProcedure(false);
  shootingProcedure(false);

  translationPID(10.0, -12.0, pi+pi/2.0, pros::millis(),400, true, true, false,0,0,10000);
  translationPID(25.0, -12.0, pi+pi/2.0, pros::millis(),700, false, true, false,0,0,10000);
  turnPID(2*pi+pi/4.0, pros::millis(), 600);
  descoreProcedure2();
  translationPID(61.0, 13.0, 2*pi+pi/2.0, pros::millis(),1200, true, true, false,0,0,10000);
  turnPID(3*pi, pros::millis(), 700);
  translationPID(58.0, -2.0, 3*pi, pros::millis(),1000, true, true, false,0,0,10000);
  translationPID(58.0, 9.0, 3*pi, pros::millis(),700, false, false, false,0,0,10000);
  translationPID(58.0, -2.0, 3*pi, pros::millis(),700, false, false, false,0,0,10000);
  translationPID(58.0, 9.0, 3*pi, pros::millis(),700, false, false, false,0,0,10000);
  translationPID(58.0, -2.0, 3*pi, pros::millis(),700, false, false, false,0,0,10000);
  translationPID(58.0, 9.0, 3*pi, pros::millis(),700, false, false, false,0,0,10000);
  translationPID(55.0, -1.0, 2.78*pi, pros::millis(),1000, false, false, false,0,0,10000);

  shootingProcedure(false);
  translationPID(55.0, 5.0, 2.78*pi, pros::millis(),800, false, false, false,0,0,10000);
